		...
		array(
			...
			__( 'Users Profiles & Activity', 'wp-security-audit-log' ) => array(
				...
				__( 'User Profiles', 'wp-security-audit-log' ) => array(
					...
					array( 4003, E_CRITICAL, __( 'User has changed his or her password', 'wp-security-audit-log' ), __( 'Successfully changed password.', 'wp-security-audit-log' ) ),
			...
			__( 'Third Party Plugins', 'wp-security-audit-log' ) => array(
				...
				__( 'WooCommerce', 'wp-security-audit-log' ) => array(
					...
					array( 9050, E_NOTICE, __( 'Order Status changed', 'wp-security-audit-log' ), __( 'Order %OrderID% change status to %OrderNewStatus%. Voucher code: %VoucherCode%', 'wp-security-audit-log' ) ),
				), 
